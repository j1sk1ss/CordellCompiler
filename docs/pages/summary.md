...
- **Educational purpose** — a language to study compiler design, interpreters, and programming language concepts. It is not intended to serve as a general-purpose language. You can try to use it, but again, it isn't his main purpose.
...
- **Permissively statically-typed**: variables can't hold values of different types. P.S.: *The compiler attempts widening implicit conversions when assigning, that's why there is no *strong typing* in the language. The narrow cast is allowed only with the 'as' keyword.*

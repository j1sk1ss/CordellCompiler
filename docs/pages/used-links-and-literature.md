...
During this project were used several sources of information. Some of them strictly about compilers and interpreters, others about related things such as assembly language, ssa form, etc. </br>
To copy the journey of the compiler building, you can use these names to ease your life: 

...
| `@[union]` | container | will allocate memory only for the biggest field |
| `@[impl(N)]` | container function | Mark a function as an implementation for a container function |

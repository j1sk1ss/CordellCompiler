- **Project overview**
  ...
  - [Design goals and scope](pages/main-idea-of-this-project.md)
  - [Project status](pages/project-status.md)
...
- **Compiler & toolchain**
  ...
  - [Liveness-based stack slot reuse](pages/liveness-based-stack-slot-reuse.md)

...
class CodeGenerator:
    ...
    def generate(self) -> str:
        ...
        b.close()
        b.line("")
        b.open("static int _peephole_subject_dead_after_rec(long pred, cfg_block_t* bb, lir_subject_t* subj, lir_block_t* start, unsigned long long counter)")
        b.line("if (!bb) return 1;")
        b.open("if (bb->visited != counter)")
        b.line("set_free(&bb->visitors);")
        b.line("set_init(&bb->visitors, SET_NO_CMP);")
        b.close()
        b.line("")
        b.line("if (set_has(&bb->visitors, (void*)pred)) return 1;")
        b.line("bb->visited = counter;")
        ...
        b.close()
        b.line("")
        b.line("return _peephole_subject_dead_after_rec(bb->id, bb->l, subj, NULL, counter) &&")
        b.line("       _peephole_subject_dead_after_rec(bb->id, bb->jmp, subj, NULL, counter);")
        b.close()
        b.line("")
        ...
        b.line("unsigned long long counter = CFG_get_unique_counter();")
        b.line("return _peephole_subject_dead_after_rec(-1, bb, subj, start, counter);")
        b.close()
        b.line("")

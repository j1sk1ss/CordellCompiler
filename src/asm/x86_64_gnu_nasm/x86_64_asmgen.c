...
static int _convert_lirblock_to_assembly(lir_block_t* b, func_info_t* fi, sym_table_t* smt, FILE* output) {
    ...
    switch (b->op) {
        ...
        case LIR_BREAKPOINT: EMIT_COMMAND("int3 ; %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                break;
        case LIR_BB:         EMIT_COMMAND("\n; BB%ld:", b->farg->storage.cnst.value);                                                             break;
        case LIR_TST:        EMIT_COMMAND("test %s, %s", format_lir_subject(b->farg, smt, NO_FLAG), format_lir_subject(b->sarg, smt, NO_FLAG));   break;
        case LIR_XCHG:       EMIT_COMMAND("xchg %s, %s", format_lir_subject(b->farg, smt, NO_FLAG), format_lir_subject(b->sarg, smt, NO_FLAG));   break;
        case LIR_MKLB:       EMIT_COMMAND("%s:", format_lir_subject(b->farg, smt, NO_FLAG));                                                      break;
        case LIR_SETL:       EMIT_COMMAND("setl %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                  break;
        case LIR_SETG:       EMIT_COMMAND("setg %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                  break;
        case LIR_STLE:       EMIT_COMMAND("setle %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                 break;
        case LIR_STGE:       EMIT_COMMAND("setge %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                 break;
        case LIR_SETE:       EMIT_COMMAND("sete %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                  break;
        case LIR_STNE:       EMIT_COMMAND("setne %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                 break;
        case LIR_SETB:       EMIT_COMMAND("setb %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                  break;
        case LIR_SETA:       EMIT_COMMAND("seta %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                  break;
        case LIR_STBE:       EMIT_COMMAND("setbe %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                 break;
        case LIR_STAE:       EMIT_COMMAND("setae %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                 break;
        case LIR_NOT:        EMIT_COMMAND("neg %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                   break;
        case LIR_INC:        EMIT_COMMAND("inc %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                   break;
        case LIR_DEC:        EMIT_COMMAND("dec %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                   break;
        case LIR_JMP:        EMIT_COMMAND("jmp %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                   break;
        case LIR_JE:         EMIT_COMMAND("je %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                    break;
        case LIR_JLE:        EMIT_COMMAND("jle %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                   break;
        case LIR_JNE:        EMIT_COMMAND("jne %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                   break;
        case LIR_JL:         EMIT_COMMAND("jl %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                    break;
        case LIR_JG:         EMIT_COMMAND("jg %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                    break;
        case LIR_JGE:        EMIT_COMMAND("jge %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                   break;
        case LIR_JA:         EMIT_COMMAND("ja %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                    break;
        case LIR_JAE:        EMIT_COMMAND("jae %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                   break;
        case LIR_JB:         EMIT_COMMAND("jb %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                    break;
        case LIR_JBE:        EMIT_COMMAND("jbe %s", format_lir_subject(b->farg, smt, NO_FLAG));                                                   break;
        case LIR_aMOV:
        case LIR_iMOV:       EMIT_COMMAND("mov %s, %s", format_lir_subject(b->farg, smt, NO_FLAG), format_lir_subject(b->sarg, smt, NO_FLAG));    break;
        case LIR_MOVZX:      EMIT_COMMAND("movzx %s, %s", format_lir_subject(b->farg, smt, NO_FLAG), format_lir_subject(b->sarg, smt, NO_FLAG));  break;
        case LIR_MOVSX:      EMIT_COMMAND("movsx %s, %s", format_lir_subject(b->farg, smt, NO_FLAG), format_lir_subject(b->sarg, smt, NO_FLAG));  break;
        case LIR_MOVSXD:     EMIT_COMMAND("movsxd %s, %s", format_lir_subject(b->farg, smt, NO_FLAG), format_lir_subject(b->sarg, smt, NO_FLAG)); break;
        case LIR_fMOV:
        ...
        case LIR_iADD:       EMIT_COMMAND("add %s, %s", format_lir_subject(b->sarg, smt, NO_FLAG), format_lir_subject(b->targ, smt, NO_FLAG));    break;
        ...
        case LIR_bOR:
        case LIR_iOR:        EMIT_COMMAND("or %s, %s", format_lir_subject(b->sarg, smt, NO_FLAG), format_lir_subject(b->targ, smt, NO_FLAG));     break;
        case LIR_fADD:       EMIT_COMMAND("addsd %s, %s", format_lir_subject(b->farg, smt, NO_FLAG), format_lir_subject(b->sarg, smt, NO_FLAG));  break;
        case LIR_fSUB:       EMIT_COMMAND("subsd %s, %s", format_lir_subject(b->farg, smt, NO_FLAG), format_lir_subject(b->sarg, smt, NO_FLAG));  break;
        case LIR_fMUL:       EMIT_COMMAND("mulsd %s, %s", format_lir_subject(b->farg, smt, NO_FLAG), format_lir_subject(b->sarg, smt, NO_FLAG));  break;
        ...
        case LIR_RAW: {
            ...
            if (percent_pos < 0) EMIT_COMMAND("%s", raw_line->body);
                ...
                string_t* replacement = create_string(format_lir_subject(b->sarg, smt, NO_FLAG));

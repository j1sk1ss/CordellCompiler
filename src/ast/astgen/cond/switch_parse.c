...
DEFINE_PARSER(cpl_parse_switch, {
    ...
    PARSER_ASSERT(!base, NULL, "Can't create a base for a 'switch' structure!");
    ...
    PARSER_ASSERT(!stmt, base, "Error during the parsing of the 'switch' statement!");
    AST_add_node(base, stmt);

    ast_node_t* cases_scope = AST_create_node_bt(CREATE_SCOPE_TOKEN);
    PARSER_ASSERT(!cases_scope, base, "Can't create a base for a case scope!");
    ...
    while (
        ...
        PARSER_ASSERT(!case_node, base, "Can't create a base for the case in the 'switch' statement!");
        ...
        PARSER_ASSERT(!case_body, base, "Error during the parsing process for the case!");
